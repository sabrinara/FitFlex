        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between px-6 md:mx-28 py-10 " data-aos="fade-right">
                <div className="w-full md:w-1/2">
                    <h3 className="text-5xl font-bold text-orange-600 pb-4">Our Vision</h3>
                ...
                <div className="w-full md:w-1/2" data-aos="fade-left">
                    <img src="https://images.unsplash.com/photo-1605296867304-46d5465a13f1?auto=format&q=80&w=600" alt="Our Vision" className="w-full h-[70vh] object-cover rounded-lg" />
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-between px-6 md:mx-28 py-10 gap-10" data-aos="fade-left">
                <div className="w-full md:w-1/2">
                    <h3 className="text-5xl font-bold text-orange-600 pb-4">Our Mission</h3>
                    <div className="text-xl md:text-2xl font-medium text-gray-400 mb-2">
                        <Typewriter
                            options={{
                ...
                <div className="w-full md:w-1/2" data-aos="fade-right">
                    <img src="https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTZ8fGd5bSUyMGVxdWlwbWVudCUyMHN0b3JlfGVufDB8fDB8fHww" alt="Our Mission" className="w-full h-[55vh] object-cover rounded-lg" />
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between px-6 md:mx-28 py-10 " data-aos="fade-right">
                <div className="w-full md:w-1/2 md:mr-10">
                    <h3 className="text-5xl font-bold text-orange-600 pb-4">Why Choose FlexFit?</h3>
                    <div className="text-xl md:text-2xl font-medium text-gray-400 mb-2">
                        <Typewriter
                            options={{
                ...
                <div className="w-full md:w-1/2" data-aos="fade-left">
                    <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&q=80&w=600" alt="Why Choose Us" className="w-full h-[60vh] object-cover rounded-lg" />
                </div>
            </div>
            ...
            <div className="py-10 md:py-20 w-full" data-aos="fade-up">
                <div className="flex flex-col items-center">
                    <h3 className="text-2xl md:text-5xl font-bold text-orange-600 pb-4">What Our Customers Say</h3>
